...
export default function Card() {
  return (
    ...
    <CardDescription>Homer Jay Simpson is a fictional character and the main protagonist of
        ...
        The Tracey Ullman Show short Good Night on April 19, 1987.</CardDescription>
    </CardWrapper>
    </>
  );
}
